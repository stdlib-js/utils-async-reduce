...
```javascript
import reduceAsync from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-reduce@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/utils-async-reduce/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/utils-async-reduce/actions/workflows/test.yml?query=branch:v0.2.3
