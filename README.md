...
```javascript
import reduceAsync from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-reduce@v0.2.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-async-reduce@v0.2.1-esm/index.mjs';
```
